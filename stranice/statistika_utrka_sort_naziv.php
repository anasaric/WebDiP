...
$upit = "sortiranje statistike utrka po nazivima";
...
$query_check = "SELECT `bodovno_stanje`.korisnik_id, `etapa`.etapa_id,`etapa`.naziv_etape, `bodovno_stanje`.uspjesno_zavrseno, `bodovno_stanje`.vrijeme FROM `etapa` LEFT JOIN `bodovno_stanje` ON `bodovno_stanje`.etapa_id=`etapa`.etapa_id ORDER BY `etapa`.`naziv_etape`";
